            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div className="space-y-12">
                    ...
                    <div className="space-y-4">
                        <h1 className="text-4xl md:text-5xl font-bold text-gradient leading-loose">
                            My Projects
                        </h1>
                        <div className="h-1 w-20 bg-gradient-to-r from-primary-600 to-primary-400 rounded-full"></div>
                        <p className="text-lg text-gray-400 max-w-3xl">
                            Here are some of my recent projects that demonstrate my experience in frontend development,
                            API integration, and building scalable React applications. Each project reflects practical
